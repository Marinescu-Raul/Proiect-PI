...
public class AdminMain {
	...
	@FXML
	private Button arhprof;
	@FXML
	private Button arhStud;
	...
	public void arhivaStudenti(ActionEvent event)throws IOException{
		Main m = new Main();
		m.changeScene("ArhivaStudenti.fxml");
	}
	
	public void arhivaProfesori(ActionEvent event)throws IOException{
		Main m = new Main();
		m.changeScene("Arhivaprofesori.fxml");
	}
